...
class Storyline:
    ...
    def __repr__(self):
        return 'Your partner is ' +self.name+' You will have ' +self.kids+ 'kids' ', You will get around by '+ self.car + ' your pet will be a '+ self.pet + ' and you will live in ' + self.location
